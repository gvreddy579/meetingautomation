          		...
          		<div class="col-lg-12">
                      ...
                      <form class="form-inline" role="form">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" numeric placeholder="From time">
                          </div>
                          <div class="form-group">
                              <label class="sr-only" numeric>To</label>
                              <input type="number" class="form-control" numeric placeholder="To time">
                          </div>
                          <div class="form-group">
                              <label class="sr-only" for="exampleInputPassword2">Title</label>
                              <input type="text" class="form-control"  placeholder="Title of meeting">
                          </div>
                           <div class="form-group">
                              <label class="sr-only" for="exampleInputPassword2">Participants</label>
                              <input type="text" class="form-control"  placeholder="Participants emp_id">
                          </div>
                          <button type="submit" class="btn btn-theme" onclick="SendPlan()">Create</button>
                      </form>
          			</div><!-- /form-panel -->
          		</div><!-- /col-lg-12 -->
          	</div><!-- /row -->
...
function showMe (it, box) {
  ...
  document.getElementById(it).style.display = vis;
          	...
          	function SendPlan()
          	{
          	alert("Thank you! We will send the link to your mail.");
          	}
          	</script>
