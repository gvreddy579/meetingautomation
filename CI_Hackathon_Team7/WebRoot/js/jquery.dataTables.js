	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text"  size="15"/>') :
			  sSearchStr==="" ? '<input type="text" size="15"/>' : sSearchStr+' <input type="text"  size="15"/>';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label style="color:#000;font:bold 11px verdana">'+sSearchStr+'</label>';
			//nFilter.innerHTML = '';
